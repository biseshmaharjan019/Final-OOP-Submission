...
ostream& operator<<(ostream& out,const Complex& c){ return out<<"("<<c.real<<(c.imag>=0?" + ":" - ")<<abs(c.imag)<<"i)"; }
istream& operator>>(istream& in,Complex& c){ cout<<"Enter real part: "; in>>c.real; cout<<"Enter imaginary part: "; in>>c.imag; return in; }
