...
public:
    PartTimeEmployee(int h,float r):hoursWorked(h),hourlyRate(r){}
...
int main()
{
    ...
    employees[0]=new FullTimeEmployee(5000);
    employees[1]=new PartTimeEmployee(80,20);
    employees[2]=new Contractor(10000,0.1f);
    for(int i=0;i<3;i++)
        employees[i]->display();
    for(int i=0;i<3;i++)
        delete employees[i];
